...
// Scroll-gescrubbte Bildsequenz (Pflasterarbeiten: Sandbett mit Richtschnur →
// Waschbetonplatten kippen ins Bild → fertig verlegter Gartenweg).
// Desktop: 168 Frames à 1280px, Mobile: 84 Frames à 768px.
const DESKTOP = { count: 168, src: (i: number) => `/frames/platten/platten-${String(i).padStart(3, "0")}.webp` };
const MOBILE = { count: 84, src: (i: number) => `/frames/platten/m/platten-${String(i).padStart(3, "0")}.webp` };
      ...
      >
        ...
        >
          <canvas
            ref={canvasRef}
            role="img"
            aria-label="Pflasterarbeiten im Zeitraffer – vom vorbereiteten Sandbett über das Setzen der Waschbetonplatten bis zum fertigen Gartenweg"
