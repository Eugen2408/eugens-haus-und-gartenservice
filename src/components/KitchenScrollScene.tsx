      ...
      >
        ...
        >
          <canvas
            ref={canvasRef}
            role="img"
            aria-label="Küchenmontage im Zeitraffer – vom Zuschnitt der Arbeitsplatte über den Brand auf der Arbeitsplatte bis zur fertig montierten Küche mit Spüle und Kochfeld"
