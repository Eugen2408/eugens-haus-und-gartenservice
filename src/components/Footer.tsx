export default function Footer() {
  return (
    <footer className="border-t border-forest-900/10 bg-white px-5 py-12 text-forest-800/80">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-8 text-center sm:flex-row sm:text-left">
        ...
        <div className="flex flex-col items-center gap-2 text-sm sm:items-end">
          <a
            ...
            className="rounded px-1 py-1 transition-colors hover:text-leaf-500"
          >
            0155 60691797
          </a>
          <a
      ...
      <div className="mx-auto mt-8 flex max-w-6xl flex-col items-center gap-3 border-t border-forest-900/10 pt-6 text-center text-xs sm:flex-row sm:justify-between">
        <p>
